...
from .views import (
    ...
    RestorePasswordView, RestorePasswordDoneView, RestorePasswordConfirmView, MovieRecomendationsView
)
...
urlpatterns = [
    ...
    path('recomendations/', LogOutView.as_view(), name='recomendation'),
